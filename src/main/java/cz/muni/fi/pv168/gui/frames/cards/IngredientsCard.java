...
public class IngredientsCard extends JPanel {
    ...
    public IngredientsCard() {
        ...
        layoutPanels(createTopPanel(), new JScrollPane(ingredientsTable));
    ...
    private JTable createRecipeTable() {
        var layout = new IngredientTableLayout();
    ...
    private void addSampleData() {
        var model = (IngredientTableLayout) ingredientsTable.getModel();
